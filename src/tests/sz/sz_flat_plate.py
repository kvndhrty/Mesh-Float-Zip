...
if __name__ == '__main__':
    ...
    for channel in range(data.shape[-1]):
        ...
        #save_stats(stats_dict, Path(r'/Users/kdoh/Library/CloudStorage/OneDrive-UCB-O365/Documents/Research/GitHub/Mesh-Float-Zip/stats') / f'sz_flat_plate_channel_{channel}_compression.pkl')

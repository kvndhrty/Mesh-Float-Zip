...
if __name__ == '__main__':
    ...
    save_stats(stats_dict, Path(r'/Users/kdoh/Library/CloudStorage/OneDrive-UCB-O365/Documents/Research/GitHub/Mesh-Float-Zip/stats/zfp') / f'zfp_neuron_compression.pkl')

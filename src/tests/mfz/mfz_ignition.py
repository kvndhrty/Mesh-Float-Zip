...
if __name__ == '__main__':
    ...
    for shuffle in [False]:
        ...
        for channel in range(data.shape[-1]):
            ...
            save_stats(stats_dict, get_parent_dir() / 'Mesh-Float-Zip\stats\mfz' / f'mfz_shuffle_{shuffle}_block_{block_size}_channel_{channel}_ignition_mesh_compression.pkl')
